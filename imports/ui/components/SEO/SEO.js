...
const seoImageURL = file => `https://s3.amazonaws.com/eruditescholarsmedia/graphics/${file}`;
const seoURL = path => Meteor.absoluteUrl(path);

const SEO = ({
  schema, title, description, images, 
  path, contentType, published, updated, category, tags, twitter,
}) => (
  <Helmet>
    ...
    <meta name="twitter:site" content="@eruditescholars2" />
    <meta name="twitter:title" content={`${title} | Erudite Scholars`} />
    <meta name="twitter:description" content={description} />
    <meta name="twitter:creator" content={`@${twitter}` || '@eruditescholars2'} />
    ...
    <meta property="og:site_name" content="Erudite Scholars" />
